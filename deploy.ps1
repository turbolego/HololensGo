...
if (-not $ProjectPath) {
    $ProjectPath = Join-Path $PSScriptRoot 'HololensGo.csproj'
}

if (-not $CertificatePath) {
    $CertificatePath = Join-Path $PSScriptRoot 'HololensGo_TemporaryKey.pfx'
}
...
Uninstall-ExistingPackage -WadcPath $wadc -IpAddress $DeviceIp -PackageNamePrefix 'HololensGo_'
